...
if __name__ == "__main__":
    ...
    # First stab at the training flow...
    # given a pronoun (yo/tu/ustedes ____) and the infinitive +  required tense, must fill in the blank line with the right conjugated verb
    # after hitting enter, the next one pops up along with a correct/incorrect indication for the prev question.
    # keep doing this in a loop until the user hits ctrl+c, at which point a print out is given of only the incorrectly answered
    # questions.
    ...
    # enter training mode, drill the existing vocab in randomly formed sentences
        ...
        while(True):
            # - loop over verb_selection, randomly selecting a verb infinitive
            ...
            # - create a card to be answered by the user, displaying the pronoun (require a lookup mapping function from 1ppl to nosotros for example)
